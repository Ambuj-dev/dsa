...
public class MaximumSumIncreasingSubsequence {
    ...
    public int findMSISMemoization(int[] nums) {
    ...
    public int findMSISTabulation(int[] nums) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(msis.findMSISMemoization(nums));
        System.out.println(msis.findMSISTabulation(nums));
