...
public class SubsequencePatternMatching {
    ...
    public int findSPMCountMemoization(String str, String pat) {
    ...
    public int findSPMCountTabulation(String str, String pat) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(spm.findSPMCountTabulation("baxmx", "ax"));
        System.out.println(spm.findSPMCountTabulation("tomorrow", "tor"));
    }
}
