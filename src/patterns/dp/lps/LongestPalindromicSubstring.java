...
public class LongestPalindromicSubstring {
    ...
    public int findLPSLengthTabulation(String st) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lps.findLPSLengthTabulation("abdbca"));
        System.out.println(lps.findLPSLengthTabulation("cddpd"));
        System.out.println(lps.findLPSLengthTabulation("pqr"));
    }
}
