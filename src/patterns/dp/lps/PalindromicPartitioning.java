...
public class PalindromicPartitioning {
    ...
    public int findMPPCutsMemoize(String st) {
    ...
    public int findMPPCutsTabulation(String st) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mpp.findMPPCutsTabulation("abdbca"));
        System.out.println(mpp.findMPPCutsTabulation("cdpdd"));
        System.out.println(mpp.findMPPCutsTabulation("pqr"));
        System.out.println(mpp.findMPPCutsTabulation("pp"));
    }
}
