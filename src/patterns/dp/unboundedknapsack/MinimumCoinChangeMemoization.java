...
public class MinimumCoinChangeMemoization {
    ...
    private int countChangeRecursive(Integer[][] dp, int[] denominations, int total, int currentIndex) {
        ...
        if(dp[currentIndex][total] == null) {
            ...
            if( denominations[currentIndex] <= total ) {
                 count1 = 1 + countChangeRecursive(dp, denominations, total - denominations[currentIndex], currentIndex);
            }
    ...
    public static void main(String[] args) {
        MinimumCoinChangeMemoization cc = new MinimumCoinChangeMemoization();
