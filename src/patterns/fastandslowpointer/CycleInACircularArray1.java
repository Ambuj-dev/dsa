...
public class CycleInACircularArray1 {
    ...
    public static void main(String[] args) {
        System.out.println(CycleInACircularArray1.loopExists(new int[] { 1, 2, -1, 2, 2 }));
        System.out.println(CycleInACircularArray1.loopExists(new int[] { 2, 2, -1, 2 }));
        System.out.println(CycleInACircularArray1.loopExists(new int[] { 2, 1, -1, -2 }));
    }
}
