...
public class FindKPairsWithLargestSums {

    //TC: O(N∗M∗logK) If we assume that both arrays have at least K elements then the time complexity can be simplified to O(K^2logK)
    //SC:O(K)
    ...
    public static void main(String[] args) {
        ...
        List<int[]> result = FindKPairsWithLargestSums.findKLargestPairs(l1, l2, 3);
