...
public class KthSmallestNumberInMSortedArray1 {
    //TC: K*logM - going through at most K elements of M input array
    ...
    public static void main(String[] args) {
        ...
        lists.add(l2);
        lists.add(l3);
        int result = KthSmallestNumberInMSortedArray1.findKthSmallest(lists, 5);
