...
public class PermutationInAString {
    ...
    public static void main(String[] args) {
        System.out.println("Permutation exist: "
                + PermutationInAString.findPermutation("oidbcaf", "abc"));
        System.out.println("Permutation exist: "
                + PermutationInAString.findPermutation("odicf", "dc"));
        System.out.println("Permutation exist: "
                + PermutationInAString.findPermutation("bcdxabcdy", "bcdyabcdx"));
        System.out.println("Permutation exist: "
                + PermutationInAString.findPermutation("aaacb", "abc"));
    }
}
