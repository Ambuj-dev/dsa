...
public class SmallestWindowContainingSubstring {
    ...
    public static void main(String[] args) {
        System.out.println(SmallestWindowContainingSubstring.findSubstring("aabdec", "abc"));//abdec
        System.out.println(SmallestWindowContainingSubstring.findSubstring("aabdec", "abac"));//aabdec
        System.out.println(SmallestWindowContainingSubstring.findSubstring("abdbca", "abc"));//bca
