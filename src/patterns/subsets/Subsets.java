...
public class Subsets {
    public static void main(String[] args) {
        ...
        System.out.println("Here is the list of subsets: " + result);
        System.out.println(findSubsetsWithDup(new int[]{1,2,2}));
        result = Subsets.findSubsetsWithDup(new int[] { 1, 3, 3 });
        System.out.println("Here is the list of subsets: " + result);

        result = Subsets.findSubsetsWithDup(new int[] { 1, 5, 3, 3 });
        System.out.println("Here is the list of subsets: " + result);
    }
    //N*2^N
    ...
    //N*2^N
    public static List<List<Integer>> findSubsetsWithDup(int[] nums) {
