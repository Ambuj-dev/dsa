...
public class MaximumNumberOfDistinctElement {
    ...
    public static void main(String[] args) {
        int result = MaximumNumberOfDistinctElement.findMaximumDistinctElements(
                new int[] { 7, 3, 5, 8, 5, 3, 3 }, 2);
        System.out.println("Maximum distinct numbers after removing K numbers: " + result);

        result = MaximumNumberOfDistinctElement.findMaximumDistinctElements(
