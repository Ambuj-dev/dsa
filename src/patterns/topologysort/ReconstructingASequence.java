...
public class ReconstructingASequence {
    ...
    public static void main(String[] args) {
        boolean result = ReconstructingASequence.canConstruct(new int[] { 1, 2, 3, 4 },
                new int[][] { new int[] { 1, 2 }, new int[] { 2, 3 }, new int[] { 3, 4 } });
        System.out.println("Can we uniquely construct the sequence: " + result);

        result = ReconstructingASequence.canConstruct(new int[] { 1, 2, 3, 4 },
                new int[][] { new int[] { 1, 2 }, new int[] { 2, 3 }, new int[] { 2, 4 } });
        System.out.println("Can we uniquely construct the sequence: " + result);

        result = ReconstructingASequence.canConstruct(new int[] { 3, 1, 4, 2, 5 },
