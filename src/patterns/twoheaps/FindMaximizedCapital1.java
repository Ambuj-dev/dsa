...
public class FindMaximizedCapital1 {
    ...
    public static void main(String[] args) {
        int result = FindMaximizedCapital1.findMaximumCapital(new int[] { 0, 1, 2 },
                new int[] { 1, 2, 3 }, 2, 1);
        System.out.println("Maximum capital: " + result);
        result = FindMaximizedCapital1.findMaximumCapital(new int[] { 0, 1, 2, 3 },
                new int[] { 1, 2, 3, 5 }, 3, 0);
        System.out.println("Maximum capital: " + result);
    }
