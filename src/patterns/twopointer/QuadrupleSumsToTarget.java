...
public class QuadrupleSumsToTarget {
    ...
    public static void main(String[] args) {
        System.out.println(
                QuadrupleSumsToTarget.searchQuadruplets(new int[] { 4, 1, 2, -1, 1, -3 }, 1));
        System.out.println(
                QuadrupleSumsToTarget.searchQuadruplets(new int[] { 2, 0, -1, 1, -2, 2 }, 2));
    }
}
